            ...
            ">
                ...
                <div className="grid grid-col-1 md:grid-cols-2 gap-6 ">
                 ...
                 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                        ...
                        <p className="text-gray-400 mb-2">Built a React-based E-commerce website where users can browse products,
                            view product details, select quantity, and manage their cart (add, update, remove items).
                            Implemented authentication with secure signup/login routes using Context API, reducers,
                            and localStorage. Managed cart state efficiently using Redux and styled the application
                            with Tailwind CSS. Added a product search feature to improve user experience.
                        </p>
                 ...
                 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                        ...
                        <p className="text-gray-400 mb-2">It is a personal portfolio website. Build using React and
                            Tailwind CSS. It display section like home, about, projects and contact.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-4">
                            {
                                ["React.js", "redux", "tailwindCSS", "react-router"].map((item) => (
