        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="glass rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
                <p className="text-gray-300 mb-6 ">
                    Passionate deveoper with experties in building scalable web application and
                    creating innivative olutions.
                </p>
                ...
                <div className="grid grid-col-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <li>
                                <strong>BCA</strong> - MACKOUT (Completed year 2018)
                            </li>
                            <li>
                                <strong>H.S</strong> - WBBOHSE (Completed year 2015)
                            </li>
                            <li>
                                <strong>S.E</strong> - WBBSE (Completed year 2012)
                            </li>
                        </ul>
                    </div>
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            <div>
                                ...
                                <p>
                                    Completed offline training and internship focused on React.js and related technologies.
                                </p>
                            </div>
